...
define dso_local zeroext i8 @Hacl_Policies_cmp_bytes_(i8* nocapture noundef readonly %0, i8* nocapture noundef readonly %1, i32 noundef %2, i8* nocapture noundef %3) local_unnamed_addr #0 {
  %.not = icmp eq i32 %2, 0
  %.pre13 = load i8, i8* %3, align 1
  br i1 %.not, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %4, %.lr.ph
  %5 = phi i8 [ %11, %.lr.ph ], [ %.pre13, %4 ]
  %.012 = phi i32 [ %12, %.lr.ph ], [ 0, %4 ]
  %6 = getelementptr inbounds i8, i8* %0, i32 %.012
  %7 = load i8, i8* %6, align 1
  %8 = getelementptr inbounds i8, i8* %1, i32 %.012
  %9 = load i8, i8* %8, align 1
  %10 = tail call fastcc zeroext i8 @FStar_UInt8_eq_mask(i8 noundef zeroext %7, i8 noundef zeroext %9)
  %11 = and i8 %10, %5
