; ModuleID = 'uint16_eq_mask.ll'
source_filename = "uint16_eq_mask.c"
target datalayout = "e-m:e-p:32:32-p270:32:32-p271:32:32-p272:64:64-i128:128-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

; Function Attrs: nounwind uwtable
define dso_local range(i32 0, 65536) i32 @main() local_unnamed_addr #0 {
  %1 = alloca i16, align 2
  %2 = alloca i16, align 2
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %1) #3
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %2) #3
  call void @high_input_2(ptr noundef nonnull %1) #3
  call void @high_input_2(ptr noundef nonnull %2) #3
  ...
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %1) #3
  ret i32 %16
}
...
declare void @high_input_2(ptr noundef) local_unnamed_addr #2
