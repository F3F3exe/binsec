...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @high_input_8(i8* nonnull %3) #3
  call void @high_input_8(i8* nonnull %4) #3
  %5 = load i64, i64* %1, align 8, !tbaa !3
  %6 = load i64, i64* %2, align 8, !tbaa !3
  %7 = and i64 %5, 9223372036854775807
  %8 = and i64 %6, 9223372036854775807
  %9 = sub nsw i64 %7, %8
  %10 = and i64 %5, -9223372036854775808
  %11 = and i64 %6, -9223372036854775808
