; ModuleID = 'libsodium/src/libsodium/crypto_hash/sha512/cp/hash_sha512.c'
source_filename = "libsodium/src/libsodium/crypto_hash/sha512/cp/hash_sha512.c"
...
declare void @sodium_memzero(i8* noundef, i32 noundef) #2
