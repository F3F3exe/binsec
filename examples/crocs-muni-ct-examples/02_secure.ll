...
define dso_local range(i32 0, 256) i32 @main(i32 noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  call void @high_input_4(ptr noundef %5)
  call void @low_input_4(ptr noundef %3)
  call void @low_input_4(ptr noundef %4)
  ...
  %12 = call zeroext i8 %.0..0.(i32 noundef %7, i8 noundef zeroext %9, i8 noundef zeroext %11)
