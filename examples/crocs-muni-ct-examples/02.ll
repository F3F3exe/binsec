...
define dso_local i32 @main(i32 %0, i8** %1) local_unnamed_addr #0 {
  ...
  call void @high_input_4(i8* %10)
  %11 = bitcast i32* %6 to i8*
  call void @low_input_4(i8* %11)
  %12 = bitcast i32* %7 to i8*
  call void @low_input_4(i8* %12)
  store volatile i8 (i32, i8, i8)* @issue, i8 (i32, i8, i8)** %9, align 4
  %13 = load volatile i8 (i32, i8, i8)*, i8 (i32, i8, i8)** %9, align 4
  %14 = load i32, i32* %8, align 4
  %15 = load i32, i32* %6, align 4
  %16 = trunc i32 %15 to i8
  %17 = load i32, i32* %7, align 4
  %18 = trunc i32 %17 to i8
  %19 = call zeroext i8 %13(i32 %14, i8 zeroext %16, i8 zeroext %18)
  %20 = zext i8 %19 to i32
  ret i32 %20
}
