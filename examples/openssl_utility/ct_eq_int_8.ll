; ModuleID = 'ct_eq_int_8.ll'
source_filename = "ct_eq_int_8.c"
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @high_input_4(i8* noundef nonnull %3) #3
  call void @high_input_4(i8* noundef nonnull %4) #3
  %5 = load i32, i32* %1, align 4, !tbaa !6
  %6 = load i32, i32* %2, align 4, !tbaa !6
  %isneg = icmp eq i32 %5, %6
  %7 = select i1 %isneg, i32 255, i32 0
