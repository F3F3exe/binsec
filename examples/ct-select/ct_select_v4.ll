...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @low_input_4(ptr noundef nonnull %2) #3
  call void @low_input_4(ptr noundef nonnull %3) #3
  %4 = load i32, ptr %2, align 4, !tbaa !6
  %5 = load i32, ptr %3, align 4, !tbaa !6
  %6 = load i8, ptr %1, align 1, !tbaa !10, !range !12, !noundef !13
  %7 = trunc nuw i8 %6 to i1
  %8 = call i32 @ct_select_u32_v4(i32 noundef %4, i32 noundef %5, i1 noundef zeroext %7) #3
...
declare void @low_input_4(ptr noundef) local_unnamed_addr #2

declare i32 @ct_select_u32_v4(i32 noundef, i32 noundef, i1 noundef zeroext) local_unnamed_addr #2
